                        ...
                        <td
                            ...
                            @if( (isset($task->pivot) && $task->pivot->permission == 'edit') ||(auth()->user()->id == $task->user_id))
                                <div class="flex flex-row justify-between">
                                    ...
                                    <button wire:click="deleteTask({{ $task }})" wire:confirm="Estás seguro de que quieres borrar esta tarea. Esta tarea se borrará permanentemente de la base de datos cada domingo."  class="bg-red-800 text-white px-4 py-2 rounded-md hover:bg-red-700">
                                        Borrar
                                    </button>
    ...
    @if ($modalShare)
        <div class="fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50 py-10">
            ...
            <div class="w-full">
                ...
                <div class="mb-8">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">
                            Se esta compartiendo la tarea con el usuario <strong>{{$user->name}}</strong>
                        </p>
                    </div>
                ...
                <div class="flex flex-row">
                    <button class="p-3 bg-black rounded-full text-white w-full font-semibold"
                    wire:click="shareTask" wire:loading.attr="disabled"
